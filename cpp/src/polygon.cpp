...
public:
     ...
     friend std::ostream& operator<<(std::ostream& stream, const Point2DT& obj)
    {
     ...
     auto X() -> COORDTYPE& { return _point[0];}
     auto Y() -> COORDTYPE& { return _point[1];}
     auto X() const -> const COORDTYPE& { return _point[0];}
     auto Y() const -> const COORDTYPE& { return _point[1];}
private:
...
public:
     ...
     friend std::ostream& operator<<(std::ostream& stream, const PointXYT& obj)
    {
     ...
     auto X() -> COORDTYPE& { return x; }
     auto Y() -> COORDTYPE& { return y; }
     auto X() const -> const COORDTYPE& { return x; }
     auto Y() const -> const COORDTYPE& { return y; }
