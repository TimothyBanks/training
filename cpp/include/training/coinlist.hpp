...
inline void autoflush(const std::string& address_a, const std::string& address_b) 
{
...
// Write a function that accepts two addresses, compares their balances, and moves funds from address_a to address_b if the balance of address_a is either more than 50% of the address_b or higher than threshold_size. Use your framework of choice (ethers.js preferred). auto-flush
